...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://localhost:7188/api/CartList")
    ...
    const deleteProduct = (id) => {
        ...
        axios.delete(`https://localhost:7188/api/${id}`)
            .then((result) => {
    ...
    const handlePlus = async (item) => {
        ...
        if (bookExist) {
            ...
            await axios.put("https://localhost:7188/api/UpdateCart", { id: bookExist.id, amount: bookExist.amount + 1, price: bookExist.price })
                .then((result) => {
    ...
    const handleMinus = (item) => {
        ...
        if (bookExist.amount === 1) {
            ...
            axios.put("https://localhost:7188/api/UpdateCart", { id: bookExist.id, amount: bookExist.amount - 1, price: bookExist.price });
