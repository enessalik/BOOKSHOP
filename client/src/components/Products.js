...
const Products = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://localhost:7188/api/ProductList")
            .then((result) => { setData(result.data.listproducts); })
            .catch((error) => console.log(error));


        axios.get("https://localhost:7188/api/CategoryList")
    ...
    const addProduct = (item) => {
        ...
        axios.post("https://localhost:7188/api/AddProduct", data)
            .then((result) => {
    ...
    const addFavorite = (id) => {
        ...
        axios.post(`https://localhost:7188/api/AddFavorite?id=${id}`)
            .then((result) => {
                if (result.data.statusCode === 200) {
                    alertify.success(result.data.statusMessage);
                }
    ...
    const handleCategory = (e, { value }) => {
        ...
        axios.get(`https://localhost:7188/api/GetByCategory?category=${value}`)
            .then((result) => {
                if (result.data.statusCode === 200) {
